...
import { addFeedback, removeFeedback, shareContent } from "@/actions/topics";
...
export default function ContentActions({
  ...
  hasHelpful: initialHelpful = false,
}: Props) {
  ...
  const [helpfulGiven, setHelpfulGiven] = useState(initialHelpful);
