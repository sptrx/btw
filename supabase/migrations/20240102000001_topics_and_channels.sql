...
create index if not exists topic_content_topic_id_idx on public.topic_content (topic_id);
create index if not exists topic_content_author_id_idx on public.topic_content (author_id);
create index if not exists topic_content_created_at_idx on public.topic_content (created_at desc);
...
create index if not exists topic_members_topic_id_idx on public.topic_members (topic_id);
create index if not exists topic_members_user_id_idx on public.topic_members (user_id);
...
create index if not exists topic_content_comments_content_id_idx on public.topic_content_comments (topic_content_id);
...
create index if not exists topic_content_feedback_content_id_idx on public.topic_content_feedback (topic_content_id);
...
create index if not exists topic_content_shares_content_id_idx on public.topic_content_shares (topic_content_id);
...
drop policy if exists "Authors can create topics" on public.topics;
...
drop policy if exists "Topic content is viewable by everyone" on public.topic_content;
create policy "Topic content is viewable by everyone" on public.topic_content for select using (true);
drop policy if exists "Authors can create topic content" on public.topic_content;
create policy "Authors can create topic content" on public.topic_content for insert with check (auth.uid() = author_id);
drop policy if exists "Authors can update own topic content" on public.topic_content;
create policy "Authors can update own topic content" on public.topic_content for update using (auth.uid() = author_id);
drop policy if exists "Authors can delete own topic content" on public.topic_content;
...
drop policy if exists "Topic members viewable by authenticated" on public.topic_members;
create policy "Topic members viewable by authenticated" on public.topic_members for select using (auth.uid() is not null);
drop policy if exists "Users can request to join" on public.topic_members;
create policy "Users can request to join" on public.topic_members for insert with check (auth.uid() = user_id);
drop policy if exists "Authors can update member status" on public.topic_members;
...
drop policy if exists "Comments viewable by everyone" on public.topic_content_comments;
create policy "Comments viewable by everyone" on public.topic_content_comments for select using (true);
drop policy if exists "Authenticated can comment" on public.topic_content_comments;
...
drop policy if exists "Feedback viewable by everyone" on public.topic_content_feedback;
create policy "Feedback viewable by everyone" on public.topic_content_feedback for select using (true);
drop policy if exists "Authenticated can give feedback" on public.topic_content_feedback;
...
drop policy if exists "Shares viewable by everyone" on public.topic_content_shares;
create policy "Shares viewable by everyone" on public.topic_content_shares for select using (true);
drop policy if exists "Authenticated can share" on public.topic_content_shares;
